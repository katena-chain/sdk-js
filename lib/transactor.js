...
class Transactor {
   ...
   */
  retrieveCertificate(companyBcId, id) {
    return this._apiHandler.retrieveCertificate(concatFqId(companyBcId, id))
  }
   ...
   * @returns {Promise<Object>}
   */
  retrieveSecret(companyBcId, id) {
    return this._apiHandler.retrieveSecret(concatFqId(companyBcId, id))
  }
